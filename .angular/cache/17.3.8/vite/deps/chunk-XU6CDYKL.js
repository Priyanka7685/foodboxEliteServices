import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-MYE2AEOU.js";
import {
  firebase
} from "./chunk-OAVB2EJF.js";
import {
  FirebaseApp
} from "./chunk-N2NQG5PO.js";
import {
  VERSION,
...
import {
  ...
  registerVersion,
  uuidv4
} from "./chunk-52HKX7TL.js";
import {
  isPlatformServer
} from "./chunk-T4BRPPEX.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-OCBKI6HO.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
@firebase/app-check/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XU6CDYKL.js.map
